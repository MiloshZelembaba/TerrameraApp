...
public abstract class ActionableCardStrings {

    /* HEADERS */
    public static final String DETECTION_HEADER = "Detection";
    public static final String PREVENTION_HEADER = "Prevention";
